...
import AlbumCard from './AlbumCard-Exercice1';
...
class ShowAlbumList extends Component {
  ...
  componentDidMount() {
    axios
      .get('http://localhost:8082/api/albums/exercice1')
      .then(res => {
        this.setState({
          albums: res.data
        })
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-12">
              <br />
              <h2 className="display-4 text-center">Albums List - Exercice 1</h2>
              <h4 className="display-5 text-center">Order by album's year ASC</h4>
            </div>

            <div className="col-md-11">
              <Link to="/create-album" className="btn btn-outline-success float-right">
                + Add New Album
              </Link>
